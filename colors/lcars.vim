...
hi Cursor guifg=#202e20 ctermfg=235 guibg=#00ff00 ctermbg=46 gui=NONE cterm=NONE
...
hi MatchParen guifg=#8bddfe ctermfg=117 guibg=#455667 ctermbg=240 gui=NONE cterm=NONE
hi NonText guifg=#455667 ctermfg=240 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Normal guifg=#cccccc ctermfg=252 guibg=#202e20 ctermbg=235 gui=NONE cterm=NONE
hi Pmenu guifg=#f8c001 ctermfg=214 guibg=#455667 ctermbg=240 gui=NONE cterm=NONE
hi PmenuSbar guifg=#f8c001 ctermfg=214 guibg=#455667 ctermbg=240 gui=NONE cterm=NONE
hi PmenuSel guifg=#8bddfe ctermfg=117 guibg=#455667 ctermbg=240 gui=NONE cterm=NONE
hi PmenuThumb guifg=#8bddfe ctermfg=117 guibg=#455667 ctermbg=240 gui=NONE cterm=NONE
hi SpecialKey guifg=#455667 ctermfg=240 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Spellbluead guifg=#00ff00 ctermfg=46 guibg=#202e20 ctermbg=235 gui=underline cterm=underline
hi SpellCap guifg=#00ff00 ctermfg=46 guibg=#202e20 ctermbg=235 gui=underline cterm=underline
hi SpellLocal guifg=#00ff00 ctermfg=46 guibg=#202e20 ctermbg=235 gui=underline cterm=underline
hi SpellRare guifg=#00ff00 ctermfg=46 guibg=#202e20 ctermbg=235 gui=underline cterm=underline
...
hi Terminal guifg=#00ff00 ctermfg=46 guibg=#202e20 ctermbg=235 gui=NONE cterm=NONE
hi healthError guifg=#d8dee9 ctermfg=254 guibg=#202e20 ctermbg=235 gui=NONE cterm=NONE
...
hi Folded guifg=#455667 ctermfg=240 guibg=#202e20 ctermbg=235 gui=NONE cterm=NONE
hi FoldColumn guifg=#455667 ctermfg=240 guibg=#202e20 ctermbg=235 gui=NONE cterm=NONE
hi SignColumn guifg=#cccccc ctermfg=252 guibg=#202e20 ctermbg=235 gui=NONE cterm=NONE
...
hi ErrorMsg guifg=#d8dee9 ctermfg=254 guibg=#202e20 ctermbg=235 gui=NONE cterm=NONE
...
hi TabLine guifg=#cccccc ctermfg=252 guibg=#202e20 ctermbg=235 gui=NONE cterm=NONE
hi TabLineFill guifg=#cccccc ctermfg=252 guibg=#202e20 ctermbg=235 gui=NONE cterm=NONE
...
hi VertSplit guifg=#455667 ctermfg=240 guibg=#202e20 ctermbg=235 gui=NONE cterm=NONE
...
hi Comment guifg=#899aab ctermfg=103 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi Function guifg=#3786ff ctermfg=69 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Number guifg=#c05858 ctermfg=131 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSFunction guifg=#3786ff ctermfg=69 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSFuncMacro guifg=#00ff00 ctermfg=46 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSParameter guifg=#ff00ff ctermfg=201 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSParameterReference guifg=#ffff00 ctermfg=226 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSMethod guifg=#ffff00 ctermfg=226 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSField guifg=#ff00ff ctermfg=201 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSVariable guifg=#00ffff ctermfg=51 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi pythonClassVar guifg=#8bddfe ctermfg=117 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi pythonStatement guifg=#ce9812 ctermfg=172 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi pythonClass guifg=#8bddfe ctermfg=117 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Sneak guifg=#202e20 ctermfg=235 guibg=#505000 ctermbg=58 gui=underline cterm=underline
hi SneakScope guifg=#00ff00 ctermfg=46 guibg=#202e20 ctermbg=235 gui=NONE cterm=NONE
hi SneakLabel guifg=#202e20 ctermfg=235 guibg=#505000 ctermbg=58 gui=underline cterm=underline
...
hi LSPDiagnosticsWarning guifg=#ffad00 ctermfg=214 guibg=NONE ctermbg=NONE gui=underline,bold cterm=underline,bold
...
hi LspDiagnosticsHint guifg=#00ff00 ctermfg=46 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsUnderlineWarning guifg=#ffad00 ctermfg=214 guibg=NONE ctermbg=NONE gui=underline,bold cterm=underline,bold
...
hi LspDiagnosticsUnderlineHint guifg=#00ff00 ctermfg=46 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
